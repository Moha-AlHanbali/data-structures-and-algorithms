...
const addOne = (arr) => {
  ...
  arr.forEach((element) => incrementedArray.push(element + 1));
...
const addExclamation = (arr) => {
  ...
  arr.forEach((element) => exclamationArray.push(element + '!'));
...
const allUpperCase = (arr) => {
  ...
  arr.forEach((element) => upperCaseArray.push(element.toUpperCase()));
...
const speaker = (words, callback) => {
  ...
  words.forEach((element) => modifiedArray.push(callback(element)));
