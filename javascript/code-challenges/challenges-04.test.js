...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  let updatedArray = arr.map((element) => {
...
const sortNames = (arr) => {
  // Solution code here...
  let capitalSmallArray = arr.sort((a, b) => {
    if (a > b) {
      return 1;
    } else if (a < b) {
      return -1;
...
const alphabetize = (arr) => {
  // Solution code here...
  let alphabeticalArray = arr.sort((a, b) => {
    if (a > b) {
      return 1;
    } else if (a < b) {
      return -1;
