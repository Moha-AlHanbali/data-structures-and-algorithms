...
const typeNum = (arr) => {
  // Solution code here...
  let numbersArray = arr.filter((element) => {
...
const containsAnd = (arr) => {
  // Solution code here...
  let andArray = arr.filter((element) => {
...
const oddValues = (arr) => {
  // Solution code here...
  let oddArray = arr.filter((element) => {
    if(element % 2 !== 0){
      return true;
    }
  });
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let allowedArray = arr.filter((element) => {
    for (let i = 0; i < arr.length; i++){
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let specialArray = arr.filter((element) => {
    if (minBaseStat < element.baseStat){
      return element;
    }
  });
  return specialArray;
...
const getStatName = (arr, minBaseStat) => {
  ...
  let filteredArray = specialArray.map((element) => {
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  let charactersArray = arr.filter((element) => {
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let numericArray = arr.filter((element) => {
    if(typeof element === 'number'){
      return element;
    }
  });
  let stringArray = numericArray.map((element) =>{
    if(element % 2 === 0){
      return 'even';
    }
    else {
